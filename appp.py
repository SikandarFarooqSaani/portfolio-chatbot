# ══════════════════════════════════════════════════════════════════════════════
# CRITICAL LINUX SERVER PATCH FOR CHROMADB
# This must remain at the absolute top of the file, before any other imports.
# ══════════════════════════════════════════════════════════════════════════════
try:
    ...
    # This safely ignores the error on your local Windows machine
    pass
